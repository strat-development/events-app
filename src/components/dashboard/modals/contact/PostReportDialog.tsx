...
export const PostReportDialog = ({ expanded, postId }: PostReportProps) => {
    const {
        register,
        handleSubmit,
        reset,
    ...
    }, [postId, reason, setValue]);

    const { submit: onSubmit } = useWeb3forms({
        access_key: apiKey,
        settings: {
            from_name: "Huddle. Reports",
            subject: "New post report Huddle.",
        },
        onSuccess: (msg, data) => {
            setIsSuccess(true);
        ...
        <>
            <Dialog open={isOpen}
                ...
                <DialogTrigger asChild>
                    <div className="flex items-center gap-1 cursor-pointer text-white/50 w-fit">
