...
export const GlareCard = ({
  ...
  return (
    ...
    >
      <div className="h-full grid will-change-transform origin-center transition-transform duration-[var(--duration)] ease-[var(--easing)] delay-[var(--delay)] [transform:rotateY(var(--r-x))_rotateX(var(--r-y))] rounded-[var(--radius)] hover:[--opacity:0.4] hover:[--duration:200ms] hover:[--easing:linear] hover:filter-none overflow-hidden">
        <div className="w-full h-full grid [grid-area:1/1] mix-blend-soft-light [clip-path:inset(0_0_0_0_round_var(--radius))]">
          <div className={cn(`h-full w-full ${isTicketExpired ? "bg-gradient-to-tr from-[#222222]/70 to-[#20232B]/70" : "bg-gradient-to-tr from-[#3D3B80]/70 to-[#B13CDF]/70"}`, className)}>
            {children}
          </div>
        </div>
